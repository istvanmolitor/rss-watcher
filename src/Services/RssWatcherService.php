...
class RssWatcherService
{
    ...
    protected function getImageFromFeedItem($item): ?string
    {
    ...
    protected function getHash(string $title, string $link, string $description, ?string $image, string $publishedAt): string
    {
    ...
    protected function saveItem(string $guid, string $title, string $link, string $description, ?string $image, string $publishedAt): RssFeedItem
    {
